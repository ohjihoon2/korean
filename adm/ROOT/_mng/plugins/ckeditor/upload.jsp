...
<%
	...
	if (isMultipart) {
		// 설정단계 		
 		//String realDir = getServletContext().getRealPath("/")+UPLOAD_DIRECTORY+"/wp_contents";
 		String realDir = UPLOAD_DIRECTORY+"/wp_contents";
 		String sFunc = request.getParameter("CKEditorFuncNum");
 		String realUrl = "/_userfiles/wp_contents/";
 
 		// 디스크 기반의 파일 아이템 팩토리 생성
		DiskFileItemFactory factory = new DiskFileItemFactory();
		factory.setSizeThreshold(MEMORY_THRESHOLD);  //최대 메모리 크기
		factory.setRepository(new File(System.getProperty("java.io.tmpdir")));  // 임시저장폴더 연결
