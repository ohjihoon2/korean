...
<%
	...
	pageContext.setAttribute("PageDescription","2016년 6월 우리말 다듬기 설문 응답내역을 조회할 수 있습니다. ( 설문입력 페이지 http://"+request.getServerName()+"/survey )");
...
<script>
	...
	{
		var f = document.aform;
		f.action="survey201606_excel.jsp";
		f.submit();		
	}
</script>
<%
	...
	try{
		...
		//전체 글수
		sql = " SELECT count(1) AS cnt FROM NARO_SURVEY a "
...
<%
				sql =" 	SELECT "
					+"		a.idx, a.q01, a.q02, a.q03, a.q04, a.q05, a.q06, a.name, a.write_ip, a.write_date "
					+"	FROM "
					+"		NARO_SURVEY a "
					+"	WHERE "
