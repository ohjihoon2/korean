...
<%
	...
	pageContext.setAttribute("PageDescription","2016년 9월 우리말 다듬기 설문 응답내역을 조회할 수 있습니다. ( 설문입력 페이지 http://"+request.getServerName()+"/survey/201609.html )");
	pageContext.setAttribute("PageMenuID","7-2");
%>
...
<script>
	...
	{
		var f = document.aform;
		f.action="survey201609_excel.jsp";
		f.submit();		
	}
</script>
<%
	...
	try{
		...
		//전체 글수
		sql = " SELECT count(1) AS cnt FROM NARO_SURVEY201609 a "
