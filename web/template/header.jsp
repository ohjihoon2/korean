	...
	<div class="gnbSub okpc">
		<div class="inner">
			<ul class="g1">
				...
				<li><a href="index.jsp?control=page&amp;part=list&amp;category=42">다듬은 말 알아보기</a></li>
				<li><a href="index.jsp?control=page&amp;part=list&amp;category=40">맛의 말, 말의 맛</a></li>
			</ul>
			<ul class="g2">
			...
			<ul class="g3">
			    <li><a href="index.jsp?control=page&amp;part=list&amp;category=41">우리말 탐구</a></li>
		...
		<div class="inner2">
			<ul class="g1">
			    <li><a href="index.jsp?control=page&amp;part=list&amp;category=38">하나 된 열정, 평창!</a></li>
	...
	<div class="mgnb nopc">
		<div class="mg1">
			...
			<ul class="">
				...
				<li><a href="index.jsp?control=page&amp;part=list&amp;category=42">다듬은 말 알아보기</a></li>
				<li><a href="index.jsp?control=page&amp;part=list&amp;category=40">맛의 말, 말의 맛</a></li>
				<li class="grey"><a href="index.jsp?control=page&amp;part=list&amp;category=38">하나 된 열정, 평창!</a></li>
				<li class="grey"><a href="index.jsp?control=page&amp;part=list&amp;category=6">전국 방언 말모이</a></li>
		...
		<div class="mg3">
			...
			<ul class="">
				...
				<li class="grey"><a href="index.jsp?control=page&amp;part=list&amp;category=13">지혜가 반짝이는 속담</a></li>
				<li class="grey"><a href="index.jsp?control=page&amp;part=list&amp;category=14">아름다운 우리말</a></li>
				<li class="grey"><a href="index.jsp?control=page&amp;part=list&amp;category=37">또 하나의 언어</a></li>
			</ul>
		</div>
		<div class="mg4">
			<p>갈무리할<br> 우리말</p>
