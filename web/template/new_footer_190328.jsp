...
<div class="footerWrap" style="display:none;">
	...
	<div class="footMenu">
	  <div class="inner">
		 <ul>
			...
			<li><a href="https://www.korean.go.kr/front/onlineQna/onlineQnaList.do?mn_id=216" target="_balnk">온라인 가나다</a></li>
	...
	<div class="foo-util">
	  <div class="newReplayWrap">
		 <ul class="newReplay">
			<li><a href="#newsletters_poppup" class="default_popup"><img src="img/common/newsletter.jpg" alt="소식지 신청하기"></a></li>
			<li><a href="index.jsp?control=page&part=replay"><img src="img/common/replay.jpg" alt="소식지 다시보기"></a></li>
		 </ul>
	  </div>
	  <div class="kr-sns">
		 <div class="util">
			<a href="https://www.facebook.com/urimal365k/" target="_blank" title="페이스북 바로가기"><img src="img/common/sns1.png" alt="페이스북"></a>
			<a href="https://twitter.com/urimal365" target="_blank" title="트위터 바로가기" class="kr-sns2"><img src="img/common/sns2.png" alt="트위터"></a>
		 </div>
	  </div>
	</div>
</div>
