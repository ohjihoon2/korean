			...
			<div class="conArea">
				<%
					...
					%>
								...
								<span class="txt"><%=news.getTitle() %></span>
								</a>
								</li>
					<% 				
								num++;}
...
<%	} %>
			<div class="ask">
				<p class="left">
					...
					<span>국어원 전자책 소식지 쉼표,마침표를<br/>
					전자우편으로 받아 보고 싶다면?</span>
					<a href="#newsletters_poppup" class="default_popup">신청하러 가기 &gt;</a>
				</p>
				<p class="right">
					<strong>소식지 다시 보기</strong>
