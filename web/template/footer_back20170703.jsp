...
<div class="footerWrap">
	<div class="footMenu">
		<div class="inner">
			<ul class="">
				<li><a href="http://stdweb2.korean.go.kr/main.jsp" target="_balnk">표준 국어 대사전</a></li>
				<li><a href="http://www.korean.go.kr/front/onlineQna/onlineQnaList.do?mn_id=61" target="_balnk">온라인 가나다</a></li>
				<li><a href="http://edu.korean.go.kr/servlet/controller.homepage.MainServlet" target="_balnk">국어 문화 학교</a></li>
